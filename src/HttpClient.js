...
class HttpClient {
  constructor(options, credentials) {
    ...
    const hostProtocolRegex =
      /^((http|https):\/\/)(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,}))$/;

    this.credentials = credentials;
    this.host = options.host ?
      (hostProtocolRegex.test(options.host) ? options.host :
        `https://${options.host}`) : "https://rest.nexmo.com";
