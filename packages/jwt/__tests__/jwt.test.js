...
describe('Token Generator', () => {
  ...
  test('Can return a valid JWT string', () => {
    ...
    assert.ok(Object.prototype.hasOwnProperty.call(decoded, 'iat'));
    assert.ok(Object.prototype.hasOwnProperty.call(decoded, 'jti'));
    assert.ok(Object.prototype.hasOwnProperty.call(decoded, 'exp'));
    assert.ok(Object.prototype.hasOwnProperty.call(decoded, 'application_id'));
  });

  test('Can return a valid JWT string with key as string', () => {
