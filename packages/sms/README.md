...
This is the Vonage SMS SDK for Node.js for use with [Vonage APIs](https://www.vonage.com/). To use it you will need a Vonage account. Sign up [for free at vonage.com][signup].
...
The SDK can be used standalone from the main [Vonage Server SDK for Node.js](https://github.com/vonage/vonage-node-sdk) if you only need to use the SMS API. All you need to do is `require('@vonage/sms')`, and use the returned object to create your own client.
