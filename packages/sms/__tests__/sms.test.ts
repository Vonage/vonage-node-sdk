...
describe("SMS", () => {
    ...
    test("can send SMS using JSON", async () => {
        ...
        nock(BASE_URL)
            .persist()
            .post('/sms/json', { api_key: '12345', api_secret: 'ABCDE', from: '11155512345', to: '447700900000', text: 'Sample SMS Text' })
            .reply(200, resp)

        const results = await client.send({ to: '447700900000', from: '11155512345', text: 'Sample SMS Text' });
