...
describe('number-insights', () => {
  ...
  test("do a basic lookup", async () => {
    ...
    expect(lookup.international_format_number).toEqual(expectedResponse.international_format_number);
    expect(lookup.national_format_number).toEqual(expectedResponse.national_format_number);
    expect(lookup.country_code).toEqual(expectedResponse.country_code);
    expect(lookup.country_code_iso3).toEqual(expectedResponse.country_code_iso3);
  ...
  test("do a standard lookup", async () => {
    ...
    expect(lookup.remaining_balance).toEqual(expectedResponse.remaining_balance);
    expect(lookup.current_carrier).toEqual(expectedResponse.current_carrier);
    expect(lookup.original_carrier).toEqual(expectedResponse.original_carrier);
  ...
  test("do an advanced lookup", async () => {
    ...
    expect(lookup.lookup_outcome_message).toEqual(expectedResponse.lookup_outcome_message);
  ...
  test("do an async advanced lookup", async () => {
    ...
    const lookup = await client.asyncAdvancedLookup('447700900000', 'https://test.com/lookup/handler')
    expect(lookup.status).toEqual(expectedResponse.status);
    expect(lookup.request_id).toEqual(expectedResponse.request_id);
