...
describe("Verify", () => {
    let client
    beforeEach(function () {
        client = new Verify({ apiKey: '12345', apiSecret: 'ABCDE' })
    });
    ...
    test("can check a verify request", async () => {
        ...
        nock(BASE_URL)
            .persist()
            .post('/verify/check/json', { api_key: '12345', api_secret: 'ABCDE', request_id: 'abcdef0123456789abcdef0123456789', code: '1234' })
            .reply(200, resp)

        const results = await client.check('abcdef0123456789abcdef0123456789', '1234');
    ...
    test("can search for a verify request", async () => {
        ...
        nock(BASE_URL)
            ...
            .query({ api_key: '12345', api_secret: 'ABCDE', request_id: 'abcdef0123456789abcdef0123456789'})
            .reply(200, resp)
    ...
    test("can cancel a verify request", async () => {
        ...
        nock(BASE_URL)
            .persist()
            .post('/verify/control/json', { api_key: '12345', api_secret: 'ABCDE', request_id: 'abcdef0123456789abcdef0123456789', cmd: 'cancel'})
            .reply(200, resp)
    ...
    test("can trigger the next event in a verify request", async () => {
        ...
        nock(BASE_URL)
            .persist()
            .post('/verify/control/json', { api_key: '12345', api_secret: 'ABCDE', request_id: 'abcdef0123456789abcdef0123456789', cmd: 'trigger_next_event'})
            .reply(200, resp)
    ...
    test("can request a verification", async () => {
        ...
        nock(BASE_URL)
            .persist()
            .post('/verify/json', { api_key: '12345', api_secret: 'ABCDE', number: '15556661234'})
            .reply(200, resp)
    ...
    test("can request a PSD2 request", async () => {
        ...
        nock(BASE_URL)
            .persist()
            .post('/verify/psd2/json', { api_key: '12345', api_secret: 'ABCDE', number: '15556661234', payee: 'Acme Inc', amount: "10.50"})
            .reply(200, resp)

        const results = await client.start(new PSD2('15556661234', 'Acme Inc', "10.50"));
        expect(results['status']).toEqual('0');
    });
})