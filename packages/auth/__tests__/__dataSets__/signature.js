...
export default [
  ...
  },
  {
    ...
    authParameters: {
      apiKey: {
        secret: AlgorithmTypes.sha1hmac,
      }}: [],
    expected: {
      api_key: '10907902800',
  ...
  },
  {
    ...
    authParameters: {
      apiKey: {
        secret: AlgorithmTypes.sha256hmac,
      }}: [],
    expected: {
      api_key: '10907902800',
  ...
  },
  {
    ...
    authParameters: {
      apiKey: {
        secret: AlgorithmTypes.sha512hmac,
      }}: [],
    expected: {
      api_key: '10907902800',
