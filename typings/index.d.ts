...
declare module "@vonage/server-sdk" {
  ...
  type AppType = "voice" | "messages" | "rtc";
  ...
  export interface AppResponse {
    ...
    name: string;
    capabilities: {
      voice?: AppCapabilities;
      messages?: AppCapabilities;
      rtc?: AppCapabilities;
    };
    keys: {
      public_key: string;
  ...
  export type AppCallback = (err: AppErrorResponse, data: AppResponse) => void;

  export class App {
    constructor(credentials: CredentialsObject, options: AppOptions);
    create(
      name: string,
      type: AppType,
      answerUrl: string,
    ...
    delete(appId: string, callback: AppCallback): void;
  }
