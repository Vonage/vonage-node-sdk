...
describe('Conversations', () => {
    ...
    it('should allow a conversation to be created', () => {
        ...
        var expectedRequestArgs = ResourceTestHelper.requestArgsMatch(params, {path: `${Conversations.PATH}`});
        expect(httpClientStub.request).to.have.been.calledWith(sinon.match(expectedRequestArgs), emptyCallback);
    });
